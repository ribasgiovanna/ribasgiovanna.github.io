  ...
  const LIBRARY = {
    pt: {
      projects:{label:'Projetos · arquivo de trabalho',items:[
        ...
        {title:'Monitor de Bueiros',type:'Protótipo IoT · ESP32 & Blynk',description:'Monitoramento de nível e alertas para explorar problemas da drenagem urbana. Projeto acadêmico em equipe.',image:'iot',caption:'painel em desenvolvimento',links:[{url:'https://youtu.be/_Lq13BLEQ2o',label:'Ver vídeo do projeto'},{url:'https://drive.google.com/file/d/1v3gQgXM4yTNJDaBZlyMATUE02FfPQoqw/view?usp=sharing',label:'Ver PDF da iniciação científica'}]},
        ...
        {title:'AdversIA',type:'Hackathon · assistente jurídico com IA',description:'Assistente para advogados de Direito de Família: analisa os documentos do caso como se fosse a parte contrária, apontando contradições, alegações sem prova e perguntas difíceis antes da audiência. Protótipo em equipe no Hackathon da Cidadania OAB/PR 2026.',image:'adversia',caption:'AdversIA',url:'https://github.com/ribasgiovanna/adversia',link:'Ver repositório'}
      ]},
    ...
    en: {
      projects:{label:'Projects · working archive',items:[
        ...
        {title:'Monitor de Bueiros',type:'IoT prototype · ESP32 & Blynk',description:'Level monitoring and alerts to explore urban-drainage problems. Academic team project.',image:'iot',caption:'dashboard in progress',links:[{url:'https://youtu.be/_Lq13BLEQ2o',label:'Watch project video'},{url:'https://drive.google.com/file/d/1v3gQgXM4yTNJDaBZlyMATUE02FfPQoqw/view?usp=sharing',label:'View scientific-initiation PDF'}]},
        ...
        {title:'AdversIA',type:'Hackathon · AI legal assistant',description:'An assistant for family-law lawyers: reviews the case documents as if it were the opposing side, surfacing contradictions, unproven claims and hard questions before the hearing. Prototype built with a team at the Hackathon da Cidadania OAB/PR 2026.',image:'adversia',caption:'AdversIA',url:'https://github.com/ribasgiovanna/adversia',link:'View repository'}
      ]},
